...
- [Ознакомление с JPA Criteria API, QueryDSL, Jooq](#ознакомление-с-jpa-criteria-api-querydsl-jooq)
- [Поверхностное ознакомление с каждой из технологий](#поверхностное-ознакомление-с-каждой-из-технологий)
- [Сравнительный анализ](#сравнительный-анализ)
  - [Поддержка JPA](#поддержка-jpa)
  - [Стиль запросов](#стиль-запросов)
  - [Типобезопасность](#типобезопасность)
  - [Уровень контроля над SQL и продуктивность в больших проектах](#уровень-контроля-над-sql-и-продуктивность-в-больших-проектах)
- [Углубление в одну из технологий](#углубление-в-одну-из-технологий)
